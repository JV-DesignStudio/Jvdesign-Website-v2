...
const POSTS = [
    ...
    },
    {
        ...
        content: 'Auto-detected from --check: IN_PROGRESS missing A14. Evidence: 2026-09-10: Resolved merge conflict in tasks.json, ran board-keeper --sync. --check No drift. validate:public PASS. File: pages/dev-board.html test:sync PASS'
    },
    {
        id: 293,
        date: '13 September 2026',
