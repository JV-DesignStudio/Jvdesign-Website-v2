...
(function() {
  ...
  /* ═══════════════════════════════════════
     ANALYTICS (lightweight local tracking)
     ═══════════════════════════════════════ */
  window.builderTrack = function(event, data) {
    try {
      var events = JSON.parse(localStorage.getItem('jvds-builder-analytics') || '[]');
  ...
  window.builderGetAnalytics = function() {
    try { return JSON.parse(localStorage.getItem('jvds-builder-analytics') || '[]'); } catch(e) { return []; }
  };
