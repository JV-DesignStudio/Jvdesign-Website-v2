...
const SKIP_DIRS = new Set(['node_modules', '.git', '.claude', 'partials', 'quest-board-deploy', '.github', 'og', 'icons', 'downloads', 'pitch-assets', 'social-posts', 'docs', 'scripts', 'StardustbookPreview', 'Session and Notes Part 2', 'Session Notes and Documents', 'chars', 'chars-orig', 'models', 'covers']);
