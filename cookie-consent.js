(function(){
  ...
  banner.innerHTML = [
    ...
    '🍪 We use <a href="/privacy-policy.html" style="color:#BC4749;font-weight:700;">cookies</a> to understand how people use this site (Google Analytics). No personal data is sold.',
    '</p>',
