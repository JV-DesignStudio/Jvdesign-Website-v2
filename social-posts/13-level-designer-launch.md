...
**Links:**
- Tool: https://jvdesignstudio.co.uk/tools/level-designer.html
- Landing: https://jvdesignstudio.co.uk/tools/level-designer-landing.html
...
Level design → playable game in one sitting. Start building! 🚀
...
### Post 2: Story/Reel Hook (Instagram/TikTok)

**Caption:**
```
POV: your students ask how platformer levels are actually made 🎮

Free browser tool. No installs. They paint tiles, draw enemy patrol paths,
hit PLAY and test their own level in 30 seconds.

Then one click turns it into a real playable game.

Teachers: this one's for your lesson plan. Link in bio. 🗺️
...
**Caption:**
```
Shipped: the JVDS Level Designer v1 🗺️

• 10 tools, 8 layers, enemy patrol paths
...
### Post 4: Devlog / Community (Bluesky / Mastodon)

**Caption:**
```
Honest dev log: the Level Designer looked finished for months, but a lost
form field meant every save & export button silently crashed. Browser tests
caught it in one run. Now it's fixed, installable, tested, and has a built-in
design critic (Level Doctor). Tools aren't products until you test them. 🩺

https://jvdesignstudio.co.uk/tools/level-designer-landing.html
```
