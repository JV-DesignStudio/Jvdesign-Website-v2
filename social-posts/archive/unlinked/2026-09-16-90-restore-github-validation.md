...
queue_file: social-posts/queue/2026-09-16-90-restore-github-validation.md
...
## Source
- devlog-data.js id=90 tag=site date="16 September 2026"
...
```
🔧 Restore GitHub validation - Node 24 clean npm ci and website build passed in the separate verification copy, and the synchronized patched dependency https://jvdesignstudio.co.uk/devlog#post-90 #JVDesignStudio #gamedev
```
...
```
**🔧 Restore GitHub validation** - 16 September 2026 - Node 24 clean npm ci and website build passed in the separate verification copy, and the synchronized patched dependency [Read note](https://jvdesignstudio.co.uk/devlog#post-90)
```
...
---
Generated: 2026-09-16T13:20:38.024Z by scripts/generate-social-draft.js from devlog-data.js id=90
