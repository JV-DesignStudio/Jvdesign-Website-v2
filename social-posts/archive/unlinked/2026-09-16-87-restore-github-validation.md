...
source: devlog-data.js id=87
url: https://jvdesignstudio.co.uk/devlog#post-87
queue_file: social-posts/queue/2026-09-16-87-restore-github-validation.md
...
## Source
- devlog-data.js id=87 tag=site date="16 September 2026"
...
```
🔧 Restore GitHub validation - Node 24 clean npm ci and website build passed in the separate verification copy, and the synchronized patched dependency https://jvdesignstudio.co.uk/devlog#post-87 #JVDesignStudio #gamedev
```
...
Read the full note → https://jvdesignstudio.co.uk/devlog#post-87
...
```
**🔧 Restore GitHub validation** - 16 September 2026 - Node 24 clean npm ci and website build passed in the separate verification copy, and the synchronized patched dependency [Read note](https://jvdesignstudio.co.uk/devlog#post-87)
```
...
- [ ] evidence names this queue file + devlog-data.js id=87 + 390/1440 no-overflow check
...
---
Generated: 2026-09-16T12:16:20.367Z by scripts/generate-social-draft.js from devlog-data.js id=87
