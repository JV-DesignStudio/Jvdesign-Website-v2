...
source: devlog-data.js id=88
url: https://jvdesignstudio.co.uk/devlog#post-88
queue_file: social-posts/queue/2026-09-16-88-restore-github-validation.md
...
## Source
- devlog-data.js id=88 tag=site date="16 September 2026"
...
```
🔧 Restore GitHub validation - Node 24 clean npm ci and website build passed in the separate verification copy, and the synchronized patched dependency https://jvdesignstudio.co.uk/devlog#post-88 #JVDesignStudio #gamedev
```
...
Read the full note → https://jvdesignstudio.co.uk/devlog#post-88
...
```
**🔧 Restore GitHub validation** - 16 September 2026 - Node 24 clean npm ci and website build passed in the separate verification copy, and the synchronized patched dependency [Read note](https://jvdesignstudio.co.uk/devlog#post-88)
```
...
- [ ] evidence names this queue file + devlog-data.js id=88 + 390/1440 no-overflow check
...
---
Generated: 2026-09-16T12:16:24.976Z by scripts/generate-social-draft.js from devlog-data.js id=88
