...
source: devlog-data.js id=85
url: https://jvdesignstudio.co.uk/devlog#post-85
queue_file: social-posts/queue/2026-09-16-85-restore-github-validation.md
...
## Source
- devlog-data.js id=85 tag=site date="16 September 2026"
...
```
🔧 Restore GitHub validation - Node 24 clean npm ci and website build passed in the separate verification copy, and the synchronized patched dependency https://jvdesignstudio.co.uk/devlog#post-85 #JVDesignStudio #gamedev
```
...
```
**🔧 Restore GitHub validation** - 16 September 2026 - Node 24 clean npm ci and website build passed in the separate verification copy, and the synchronized patched dependency [Read note](https://jvdesignstudio.co.uk/devlog#post-85)
```
...
- [ ] evidence names this queue file + devlog-data.js id=85 + 390/1440 no-overflow check
...
---
Generated: 2026-09-16T12:15:54.361Z by scripts/generate-social-draft.js from devlog-data.js id=85
