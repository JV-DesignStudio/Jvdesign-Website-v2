...
source: devlog-data.js id=86
url: https://jvdesignstudio.co.uk/devlog#post-86
queue_file: social-posts/queue/2026-09-16-86-repair-the-project-tracker-document.md
...
## Source
- devlog-data.js id=86 tag=apps date="16 September 2026"
...
```
🔧 Repair the project tracker document - A fresh mobile load of tools/project-tracker.html visibly exposes script text, overflows horizontally and requests a mal https://jvdesignstudio.co.uk/devlog#post-86 #JVDesignStudio #gamedev
```
...
Read the full note → https://jvdesignstudio.co.uk/devlog#post-86
...
```
**🔧 Repair the project tracker document** - 16 September 2026 - A fresh mobile load of tools/project-tracker.html visibly exposes script text, overflows horizontally and requests a mal [Read note](https://jvdesignstudio.co.uk/devlog#post-86)
```
...
- [ ] evidence names this queue file + devlog-data.js id=86 + 390/1440 no-overflow check
...
---
Generated: 2026-09-16T12:16:17.315Z by scripts/generate-social-draft.js from devlog-data.js id=86
